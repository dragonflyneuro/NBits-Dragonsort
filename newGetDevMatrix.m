function [devMatrix, templateWavesSet] = newGetDevMatrix(uA, t, currentBatch, templateBatches, orphanWaves, sRate, numTemplates, fuzzyBool)
...
for ii = 1:length(uA)
    ...
    [~,templateWaves,~,~] = uA(ii).getAssignedSpikes(t,currentBatch,templateBatches);
