...
cropBool = 1; % 1 if you want to crop the waves closer to the spike time
spikeWidth = 0.5; % estimated halfwidth of a wave in ms. Used to crop spikes when cropBool == 1
uniformLength = 0.3; % the width of uniform gain in ms. Used when weighing samples around the spike time
bias = 0.05; % sample weighting function centreing bias
