function d = newDeviationRefine(uA, t, orphanWaves, currentBatch, templateBatches, numTemplates, sRate, scaleArray, d)
...
if isfield(d, 'devMatrix')
    ...
    [devMatrix, d.tempWavesSet] = newGetDevMatrix(uA, t, currentBatch, templateBatches, orphanWaves, sRate, numTemplates, 0);
