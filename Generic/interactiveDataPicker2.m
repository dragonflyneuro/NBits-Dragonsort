function I = interactiveDataPicker2(f, ax, markers)
% Daniel Ko (dsk13@ic.ac.uk) [May 2020]
...
function e = waiter(f, ax, b)
% Daniel Ko (dsk13@ic.ac.uk) [Feb 2020]
% Takes figure and axes handles and puts hotkeys to zoom/pan/pointer
% controls.
%
% INPUT
% f = figure containing ax
% ax = axes with data to look through
%
% OUTPUT
% e = true if figure does not exist anymore
